...
namespace Ebada.Scgl.Model
{
    ...
    public class PJ_pbdldrqtz
    {
        ...
        private string _pdname=String.Empty; 
        ...
        /// 属性名称：pdName
        /// 属性描述：配变名称
        /// 字段信息：[pdName],nvarchar
        /// </summary>
        [DisplayNameAttribute("配变名称")]
        public string pdName
        {
            ...
            {			
                if(value==null)return;
                if( value.ToString().Length > 50)
                throw new Exception("[配变名称]长度不能大于50!");
                if (_pdname as object == null || !_pdname.Equals(value))
                {
                    _pdname = value;
                }
            }			 
        ...
        public string lineName
        {
            ...
            {			
                if(value==null)return;
                if( value.ToString().Length > 50)
                throw new Exception("[所属线路名称]长度不能大于50!");
