...
{
    /// <summary>
    ///[PS_WorkTaskCommands]业务实体类
    ///对应表名:PS_WorkTaskCommands
    /// </summary>
    [Serializable]
    public class WF_WorkTaskCommands
    {
        
        #region Private 成员
        private string _commandid=Newid(); 
        ...
        public string CommandId
        {
            ...
            {			
                ...
                if (_commandid as object == null || !_commandid.Equals(value))
                {
                    _commandid = value;
                }
            }			 
