                ...
                if (btSelectList.EditValue.ToString() == "1")
                {
                    if (btGdsList.EditValue != null&&btGdsList.EditValue.ToString() == "0")
                    {
                        ...
                        foreach (ViewGds gds in list)
                        {
                            ...
                            ht6.Add("lineVol", "10");
                            object gtcount10 = Client.ClientHelper.PlatformSqlMap.GetObject("GetPS_gtcountbyProc", ht6);
                            ...
                            ht7.Add("lineVol", "0.4");
                            object gtcount04 = Client.ClientHelper.PlatformSqlMap.GetObject("GetPS_gtcountbyProc", ht7);
