...
namespace Ebada.Scgl.Yxgl {
    ...
    /// 文档
    /// </summary>
    public class ExportSD06
    {
        public static void ExportExcel(Dictionary<string,List<sdjl_06sbxs>> objdic)
        {
            ExcelAccess ex = new ExcelAccess();
            SaveFileDialog saveFileDialog1 = new SaveFileDialog();
            string fname = Application.StartupPath + "\\00记录模板\\送电06设备巡视及缺陷消除记录.xls";
            ...
            int pags = 0;
            foreach ( KeyValuePair<string,List<sdjl_06sbxs>> pp in objdic)
            {
