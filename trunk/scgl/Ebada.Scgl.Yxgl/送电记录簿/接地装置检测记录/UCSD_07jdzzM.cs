...
namespace Ebada.Scgl.Yxgl {
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class UCSD_07jdzzM : DevExpress.XtraEditors.XtraUserControl {
        /// <summary>
        /// 
        /// </summary>
        public UCSD_07jdzzM()
        {
            InitializeComponent();
            //接收行焦点改变事件
            ucTop.FocusedRowChanged += new Ebada.Client.SendDataEventHandler<sdjl_07jdzz>(ucTop_FocusedRowChanged);
        }
