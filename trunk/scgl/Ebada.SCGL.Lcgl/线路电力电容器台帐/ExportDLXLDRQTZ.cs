...
namespace Ebada.Scgl.Lcgl
{
    ...
    public class ExportDLXLDRQTZ
    {
        ...
        public  void ExportExcel(IList<PJ_dlxldrqtz> datalist)
        {
            //lgm
            ExcelAccess ex = new ExcelAccess();
            SaveFileDialog saveFileDialog1 = new SaveFileDialog();
            string fname = Application.StartupPath + "\\00记录模板\\线路电力电容器台帐.xls";
            ex.Open(fname);
        ...
        public void ExportExcel(ExcelAccess ex ,IList<PJ_dlxldrqtz> datalist)
        {
            //此处写填充内容代码
            int row = 6;
            int col = 1;
            ...
            for (int j = 0; j < datalist.Count; j++)
            {
                ...
                ex.SetCellValue(datalist[j].gtNumber, row + j % rowcount, col + 2);
