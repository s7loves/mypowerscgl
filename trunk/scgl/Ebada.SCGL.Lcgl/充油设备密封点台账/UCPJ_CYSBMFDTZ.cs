...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_CYSBMFDTZ : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_cysbmfdtz> gridViewOperation;

        public event SendDataEventHandler<PJ_cysbmfdtz> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_cysbmfdtz,LP_Record";
        ...
        public UCPJ_CYSBMFDTZ()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_cysbmfdtz>(gridControl1, gridView1, barManager1, new frmCYSBMFDTZEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_cysbmfdtz>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_cysbmfdtz>(gridViewOperation_AfterAdd);
            gridViewOperation.AfterDelete += new ObjectEventHandler<PJ_cysbmfdtz>(gridViewOperation_AfterDelete);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_cysbmfdtz>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }
        void gridViewOperation_AfterDelete(PJ_cysbmfdtz obj)
        {
        ...
        void gridViewOperation_AfterAdd(PJ_cysbmfdtz newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_cysbmfdtz> e)
        {
           
        }

        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_cysbmfdtz> e)
        {
            if (parentID == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_cysbmfdtz);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_cysbmfdtz> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_cysbmfdtz newobj)
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            IList<PJ_cysbmfdtz> datalist = gridView1.DataSource as IList<PJ_cysbmfdtz>;
            ExportCYSBMFDTZ etdjh = new ExportCYSBMFDTZ();
