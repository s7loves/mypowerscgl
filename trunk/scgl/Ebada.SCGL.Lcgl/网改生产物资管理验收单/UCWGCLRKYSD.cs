...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCWGCLRKYSD : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_wgclrkysd> gridViewOperation;

        frmWGCLRKYSEdit frm = new frmWGCLRKYSEdit();

        public event SendDataEventHandler<PJ_wgclrkysd> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_wgclrkysd,LP_Record";
        ...
        public UCWGCLRKYSD()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_wgclrkysd>(gridControl1, gridView1, barManager1,frm );
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_wgclrkysd>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_wgclrkysd>(gridViewOperation_AfterAdd);
            gridViewOperation.AfterDelete += new ObjectEventHandler<PJ_wgclrkysd>(gridViewOperation_AfterDelete);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_wgclrkysd>(gridViewOperation_BeforeDelete);
            gridViewOperation.BeforeEdit += new ObjectOperationEventHandler<PJ_wgclrkysd>(gridViewOperation_BeforeEdit);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_wgclrkysd>(gridViewOperation_BeforeUpdate);
            gridViewOperation.AfterEdit += new ObjectEventHandler<PJ_wgclrkysd>(gridViewOperation_AfterEdit);
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_wgclrkysd> e)
        {
           

        }
        void gridViewOperation_BeforeEdit(object render, ObjectOperationEventArgs<PJ_wgclrkysd> e)
        {
            
        }
        void gridViewOperation_AfterEdit(PJ_wgclrkysd obj)
        {

            RefreshData(" where     1=1");
        }
        void gridViewOperation_AfterDelete(PJ_wgclrkysd obj)
        {
        ...
        void gridViewOperation_AfterAdd(PJ_wgclrkysd newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_wgclrkysd> e)
        {

        }

        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_wgclrkysd> e)
        {
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_wgclrkysd);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_wgclrkysd> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_wgclrkysd newobj)
        {
        ...
        private void barEditGC_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            System.Collections.IList mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct ssxm  from PJ_wgclrkysd where  ssgc='" + barEditGC.EditValue + "'  and ssxm!='' ");
            repositoryItemComboBox2.Items.AddRange(mclist);

            repositoryItemComboBox3.Items.Clear();
            mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpmc  from PJ_wgclrkysd where  ssgc='" + barEditGC.EditValue + "'  and wpmc!='' ");
            repositoryItemComboBox3.Items.AddRange(mclist);

            repositoryItemComboBox4.Items.Clear();
            mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpgg  from PJ_wgclrkysd where  ssgc='" + barEditGC.EditValue + "'  and wpgg!='' ");
        ...
        private void barEditFGC_EditValueChanged(object sender, EventArgs e)
        {
            ...
            inidate();
            repositoryItemComboBox3.Items.Clear();
            IList mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpmc  from PJ_wgclrkysd where  ssxm='" + barEditFGC.EditValue + "'  and wpmc!='' ");
            repositoryItemComboBox3.Items.AddRange(mclist);

            repositoryItemComboBox4.Items.Clear();
            mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpgg  from PJ_wgclrkysd where  ssxm='" + barEditFGC.EditValue + "'  and wpgg!='' ");
            repositoryItemComboBox4.Items.AddRange(mclist);
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            //IList<PJ_wgclrkysd> datalist = gridView1.DataSource as IList<PJ_wgclrkysd>;
            frmProjectSelect fys = new frmProjectSelect();
            fys.strType = " and 1=1";
            fys.StrSQL = "select distinct ssgc  from PJ_wgclrkysd where  1=1";
        ...
        private void SubmitButton_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fys.ShowDialog() == DialogResult.OK)
            {
                ExportWGCLRKYSEdit export = new ExportWGCLRKYSEdit();
        ...
        private void barCopy_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            fys.strType = " and 1=1";
            fys.StrSQL = "select distinct dhht  from PJ_wgclrkysd where  1=1 and dhht!=''";
            if (fys.ShowDialog() == DialogResult.OK)
            {
                ...
                IList<PJ_wgclcrkd> cdatalist = new List<PJ_wgclcrkd>();
                string num = "";
                ...
                PJ_wgclcrkd lc = null;
                foreach (PJ_wgclrkysd ysd in datalist)
                {
                    lc = MainHelper.PlatformSqlMap.GetOne<PJ_wgclcrkd>(" where lyparent='"+ysd.ID +"' and type = '工程材料入库单'");
                    if (lc == null)
                    {
                        PJ_wgclcrkd clc = new PJ_wgclcrkd();
                        clc.ID = clc.CreateID();
                        clc.ssgc = ysd.ssgc;
                        clc.ssxm = ysd.ssxm;
                        clc.type = "工程材料入库单";
                ...
                frmWGCLRKYSShow fss = new frmWGCLRKYSShow();
        ...
        private void barExplorYear_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fys.ShowDialog() == DialogResult.OK)
            {
                ExportWGCLRKYSEdit etdjh = new ExportWGCLRKYSEdit();
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            MainHelper.PlatformSqlMap.DeleteByWhere<PJ_wgclcrkd>(" where 1=1");
            MainHelper.PlatformSqlMap.DeleteByWhere<PJ_wgclrkysd>(" where 1=1");
            RefreshData("where  1=1" );
        }
