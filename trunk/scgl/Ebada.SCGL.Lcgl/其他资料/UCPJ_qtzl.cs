...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_qtzl : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_qtzl> gridViewOperation;

        public event SendDataEventHandler<PJ_qtzl> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_qtzl,LP_Record";
        ...
        public UCPJ_qtzl()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_qtzl>(gridControl1, gridView1, barManager1, new frmqtzlEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_qtzl>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_qtzl>(gridViewOperation_BeforeUpdate);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_qtzl>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_qtzl>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }

        void gridViewOperation_AfterAdd(PJ_qtzl newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_qtzl> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_qtzl> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_qtzl> e)
        {
            if (parentID == null)
                e.Cancel = true;
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_qtzl);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_qtzl> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_qtzl newobj)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_qtzl;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_qtzl>(frm.pjobject);
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.FocusedRowHandle > -1)
            {
                PJ_qtzl OBJECT = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_qtzl;
