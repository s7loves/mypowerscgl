...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_lcjh : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_lcjh> gridViewOperation;

        public event SendDataEventHandler<PJ_lcjh> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_lcjh,LP_Record";
        ...
        public UCPJ_lcjh()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_lcjh>(gridControl1, gridView1, barManager1, new frmlcjhEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_lcjh>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_lcjh>(gridViewOperation_BeforeUpdate);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_lcjh>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_lcjh>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }

        void gridViewOperation_AfterAdd(PJ_lcjh newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_lcjh> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_lcjh> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_lcjh> e)
        {
            if (parentID == null)
                e.Cancel = true;
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_lcjh);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_lcjh> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_lcjh newobj)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_lcjh;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_lcjh>(frm.pjobject);
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.FocusedRowHandle > -1)
            {
                PJ_lcjh OBJECT = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_lcjh;
