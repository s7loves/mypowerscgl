...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_12kgsy : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_12kgsy> gridViewOperation;
        
        public event SendDataEventHandler<PJ_12kgsy> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_12kgsy,LP_Record";
        ...
        public UCPJ_12kgsy()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_12kgsy>(gridControl1, gridView1, barManager1,new frm12kgsyEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_12kgsy>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_12kgsy>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_12kgsy>(gridViewOperation_AfterAdd);
        }
        /// <summary>
        /// 隐藏选择列表
        /// </summary>
        ...
        void gridViewOperation_AfterAdd(PJ_12kgsy obj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_12kgsy> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_12kgsy> e)
        {
            if (parentID == null || PSObj == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_12kgsy);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_12kgsy> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_12kgsy newobj)
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //{
            //     IList<PJ_12kgsy> pjlist=new List<PJ_12kgsy>();
            //    for (int i = 0; i < gridView1.RowCount; i++)
            //    {
            //        pjlist.Add(gridView1.GetRow(i) as PJ_12kgsy);
            //    }
