...
{
    public partial class UCWGCKGL: UserControl
    {
        public UCWGCKGL()
        {
            InitializeComponent();
        ...
        {
            frmWGCLCKXZ frm = new frmWGCLCKXZ();
            ...
            {
                if (pnumli.Count == 0)
                    clccktemp.num = "SCCK" + DateTime.Now.ToString("yyyyMMdd") + string.Format("{0:D4}", 1);
                else
                {
                    clccktemp.num = "SCCK" + (Convert.ToDecimal(pnumli[0].num.Replace("SCCK", "")) + 1);
            ...
            else
            {
                if (pnumli.Count > 0)
                {
                    ...
                    if ((Convert.ToDecimal(clccktemp.num.Replace("SCCK", ""))) - (Convert.ToDecimal(pnumli[0].num.Replace("SCCK", "")))>1)
                    {
                        clccktemp.num = "SCCK" + (Convert.ToDecimal(pnumli[0].num.Replace("SCCK", "")+1) );
                    }
                }
            ...
            if (frm.ShowDialog() == DialogResult.OK)
            {
                ...
                frmWGCLCKXZShow frmshow = new frmWGCLCKXZShow();
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            frmWGCLCKSingleXZ frm = new frmWGCLCKSingleXZ();
            frm.RowData = new PJ_wgclcrkd();
            ...
            <PJ_wgclcrkd>(" where  id like '" + DateTime.Now.ToString("yyyyMMdd") + "%' and type='" + comboBoxEdit6.Text + "' order by id desc ");
            if (pnumli.Count == 0)
                ((PJ_wgclcrkd)frm.RowData).num = "SCCK" + DateTime.Now.ToString("yyyyMMdd") + string.Format("{0:D4}", 1);
            else
            {
                ((PJ_wgclcrkd)frm.RowData).num = "SCCK" + (Convert.ToDecimal(pnumli[0].num.Replace("SCCK", "")) + 1);
