...
namespace Ebada.Scgl.Lcgl {
    ...
    public partial class UCmjddzWGInquiry : DevExpress.XtraEditors.XtraUserControl {
        ...
        public UCmjddzWGInquiry()
        {
            InitializeComponent();
            initImageList();

            gridViewOperation = new GridViewOperation<PJ_wgclcrkd>(gridControl1, gridView1, barManager1,new frmLP());            
            ...
            //gridViewOperation.BeforeInsert += new ObjectOperationEventHandler<PJ_wgclcrkd>(gridViewOperation_BeforeInsert);
        ...
        void gridViewOperation_BeforeInsert(object render, ObjectOperationEventArgs<PJ_wgclcrkd> e)
        {
        ...
        private void btDeletefrm_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                MainHelper.PlatformSqlMap.DeleteByWhere<PJ_wgclcrkd>(" where id ='" + dr["ID"].ToString() + "'");
                InitData(strKind);
            }
            catch (Exception ex)
            {
