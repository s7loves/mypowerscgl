...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_BDSDLDRQTZ : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_bdsdldrqtz> gridViewOperation;

        public event SendDataEventHandler<PJ_bdsdldrqtz> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_bdsdldrqtz,LP_Record";
        ...
        public UCPJ_BDSDLDRQTZ()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_bdsdldrqtz>(gridControl1, gridView1, barManager1, new frmBDSDLDRQTZEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_bdsdldrqtz>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_bdsdldrqtz>(gridViewOperation_AfterAdd);
            gridViewOperation.AfterDelete += new ObjectEventHandler<PJ_bdsdldrqtz>(gridViewOperation_AfterDelete);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_bdsdldrqtz>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }
        void gridViewOperation_AfterAdd(PJ_bdsdldrqtz newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_AfterDelete(PJ_bdsdldrqtz obj)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_bdsdldrqtz> e)
        {
           
        }

        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_bdsdldrqtz> e)
        {
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_bdsdldrqtz);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_bdsdldrqtz> GridViewOperation
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            IList<PJ_bdsdldrqtz> datalist = gridView1.DataSource as IList<PJ_bdsdldrqtz>;
            ExportBDSDLDRQTZ etdjh = new ExportBDSDLDRQTZ();
