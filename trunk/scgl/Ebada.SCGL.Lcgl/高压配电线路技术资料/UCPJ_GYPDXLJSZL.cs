...
namespace Ebada.Scgl.Lcgl
{
    ...
    public partial class UCPJ_GYPDXLJSZL : DevExpress.XtraEditors.XtraUserControl {
        ...
        public void InitData() {
            Temple = MainHelper.PlatformSqlMap.GetOne<LP_Temple>(" where ( ParentID not in (select LPID from LP_Temple where 1=1 and  CtrlSize!='目录') and  CtrlSize!='目录' ) and  CellName = '高压配电线路技术档案'");
