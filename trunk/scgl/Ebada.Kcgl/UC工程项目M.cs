...
namespace Ebada.Kcgl {
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class UC工程项目M : DevExpress.XtraEditors.XtraUserControl {
        /// <summary>
        /// 
        /// </summary>
        public UC工程项目M() {
        ...
        void ucTop_FocusedRowChanged(object sender, kc_工程类别 obj) {
            ...
            splitCC1.Panel1.Text = "工程类别列表";
            splitCC1.Panel2.Text = "工程项目列表：" + (obj != null ? obj.工程类别 : "");
        }

        protected override void OnLoad(EventArgs e) {
            base.OnLoad(e);
            ucTop.InitData();
           ucTop.ChildView2 = ucBottom.GridViewOperation;
        }
