           ...
           for (int j = 1; j <= pageindex; j++)
           {
               ...
               if (nrList.Count > endrow)
               {
                   for (int i = 0; i < 7; i++)
                   {
                       ...
                       ex.SetCellValue(nrList[starow - 1 + i].预计时间.ToString(), row + 5 + i, 3);
                       ...
                       ex.SetCellValue(nrList[starow - 1 + i].完成时间.ToString(), row + 5 + i, 7);
                       ex.SetCellValue(nrList[starow - 1 + i].未完成原因, row + 5 + i, 8);
                       ex.SetCellValue(nrList[starow - 1 + i].完成时间.ToString(), row + 5 + i, 9);
