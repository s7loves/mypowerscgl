...
namespace Ebada.Kcgl {
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class UC返库明细表 : DevExpress.XtraEditors.XtraUserControl {
        ...
        public void InitColumns() {
            ...
            gridView1.Columns[kc_入库明细表.f_供货厂家_ID].Caption = "工程项目";
            ...
            gridView1.Columns[kc_入库明细表.f_供货厂家_ID].ColumnEdit = getLookup<kc_工程项目>(kc_工程项目.f_ID, kc_工程项目.f_工程项目名称);
