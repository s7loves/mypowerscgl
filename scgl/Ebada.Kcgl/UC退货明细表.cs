...
namespace Ebada.Kcgl {
    ...
    public partial class UC退货明细表 : DevExpress.XtraEditors.XtraUserControl {
        ...
        public void InitColumns() {
            ...
            gridView1.Columns[kc_退货明细表.f_材料名称_ID].ColumnEdit = getLookup<kc_材料名称表>(kc_材料名称表.f_ID, kc_材料名称表.f_材料名称);
            gridView1.Columns[kc_退货明细表.f_材料名称_ID].ColumnEdit.EditValueChanging += new ChangingEventHandler(材料名称表ColumnEdit_EditValueChanging);
