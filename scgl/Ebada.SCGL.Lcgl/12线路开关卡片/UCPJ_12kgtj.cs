...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_12kgtj : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PS_kgjctj> gridViewOperation;
        public event SendDataEventHandler<PS_kgjctj> FocusedRowChanged;
        ...
        private string varDbTableName = "PS_kgjctj,LP_Record";
        ...
        public UCPJ_12kgtj()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PS_kgjctj>(gridControl1, gridView1, barManager1, new frmPJ_12kgtj());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PS_kgjctj>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PS_kgjctj>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PS_kgjctj>(gridViewOperation_AfterAdd);
        }
        /// <summary>
        /// 隐藏选择列表
        /// </summary>
        ...
        void gridViewOperation_AfterAdd(PS_kgjctj obj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PS_kgjctj> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PS_kgjctj> e)
        {
            if (parentID == null || PSObj == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PS_kgjctj);
        }
        ...
        {
            btView.Visibility = DevExpress.XtraBars.BarItemVisibility.Always;
            if (isWorkflowCall)
            {
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PS_kgjctj> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PS_kgjctj newobj)
        {
        ...
        {
            IList<PS_kgjctj> datalist = gridControl1.DataSource as IList<PS_kgjctj>;
            if (datalist != null && datalist.Count > 0)
            {
                Export12.ExportExcel10KV(datalist);
            }
