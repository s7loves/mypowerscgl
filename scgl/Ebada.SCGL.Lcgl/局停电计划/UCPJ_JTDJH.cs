...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class UCPJ_JTDJH : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UCPJ_JTDJH()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_tdjh>(gridControl1, gridView1, barManager1, true);
        ...
        public void InitColumns()
        {
           ...
           // gridView1.Columns["S3"].Caption = "选择流程";
            ...
            gridView1.Columns["IsSelect"].OptionsColumn.AllowEdit = true;
            //DevExpress.XtraEditors.Repository.RepositoryItemComboBox cob = new RepositoryItemComboBox();
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            ...
            ExportJTDJH etdjh = new ExportJTDJH();
        ...
        private void SubmitButton_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fms.ShowDialog() == DialogResult.OK)
            {
                ExportJTDJH export = new ExportJTDJH();
        ...
        /// 保存表格单元格中的编辑
        /// </summary>
        private void columeEdit(object obj,EventArgs ea)
        {
            int a;
        }
