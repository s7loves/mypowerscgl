...
namespace Ebada.Scgl.Lcgl
{
    ...
    public partial class UCPJ_16 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private string varDbTableName = "PJ_16,LP_Record";
        ...
        public UCPJ_16()
        {
            ...
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_16>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_16>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }

        void gridViewOperation_AfterAdd(PJ_16 obj)
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
           ...
           {
               PJ_16 p16 = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_16;
               Export16.ExportExcel(p16);
           }
            else
           {
               return;
