...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCSBBZQSBGMXB1 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private string varDbTableName = "PJ_sbbzqsbgmxb1,LP_Record";
        ...
        public UCSBBZQSBGMXB1()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_sbbzqsbgmxb1>(gridControl1, gridView1, barManager1, new frmSBBZQSBGMXB1Edit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_sbbzqsbgmxb1>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_sbbzqsbgmxb1>(gridViewOperation_AfterAdd);
            gridViewOperation.AfterDelete += new ObjectEventHandler<PJ_sbbzqsbgmxb1>(gridViewOperation_AfterDelete);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_sbbzqsbgmxb1>(gridViewOperation_BeforeDelete);
        ...
        void gridViewOperation_AfterDelete(PJ_sbbzqsbgmxb1 obj)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_sbbzqsbgmxb1> e)
        {
            if (parentID == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_sbbzqsbgmxb1);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_sbbzqsbgmxb1> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_sbbzqsbgmxb1 newobj)
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            //IList<PJ_sbbzqsbgmxb1> datalist = gridView1.DataSource as IList<PJ_sbbzqsbgmxb1>;
            //frmYearSelect fys = new frmYearSelect();
            //fys.StrSQL = "select distinct left(CONVERT(varchar(50) , indate, 112 ),4 )  from PJ_sbbzqsbgmxb1";
            //if (fys.ShowDialog() == DialogResult.OK)
            {

                ExportSBBZQSBGMXB1Edit etdjh = new ExportSBBZQSBGMXB1Edit();
        ...
        private void SubmitButton_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            ExportSBBZQSBGMXB1Edit export = new ExportSBBZQSBGMXB1Edit();
        ...
        private void barCopy_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    return;
            //}
            //IList<PJ_sbbzqsbgmxb1> bjlist = Client.ClientHelper.PlatformSqlMap.GetList<PJ_sbbzqsbgmxb1>("where orgcode='" + btGdsList.EditValue + "' AND jhnf='"+DateTime.Now.Year+"'");
            //List<PJ_sbbzqsbgmxb1> list = new List<PJ_sbbzqsbgmxb1>();
            //foreach (PJ_sbbzqsbgmxb1 bj in bjlist)
            //{
            //    bj.ID = bj.CreateID();
