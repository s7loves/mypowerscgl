...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCSBBZQSBGMXB3 : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_sbbzqsbgmxb3> gridViewOperation;

        public event SendDataEventHandler<PJ_sbbzqsbgmxb3> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_sbbzqsbgmxb3,LP_Record";
        ...
        public UCSBBZQSBGMXB3()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_sbbzqsbgmxb3>(gridControl1, gridView1, barManager1, new frmSBBZQSBGMXB3Edit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_sbbzqsbgmxb3>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_sbbzqsbgmxb3>(gridViewOperation_AfterAdd);
            gridViewOperation.AfterDelete += new ObjectEventHandler<PJ_sbbzqsbgmxb3>(gridViewOperation_AfterDelete);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_sbbzqsbgmxb3>(gridViewOperation_BeforeDelete);
        ...
        void gridViewOperation_AfterDelete(PJ_sbbzqsbgmxb3 obj)
        {
        ...
        void gridViewOperation_AfterAdd(PJ_sbbzqsbgmxb3 newobj)
        {
            //if (isWorkflowCall)
            //{
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_sbbzqsbgmxb3> e)
        {
           
        }

        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_sbbzqsbgmxb3> e)
        {
            if (parentID == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_sbbzqsbgmxb3);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_sbbzqsbgmxb3> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_sbbzqsbgmxb3 newobj)
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            //IList<PJ_sbbzqsbgmxb3> datalist = gridView1.DataSource as IList<PJ_sbbzqsbgmxb3>;
            //frmYearSelect fys = new frmYearSelect();
            //fys.StrSQL = "select distinct left(CONVERT(varchar(50) , indate, 112 ),4 )  from PJ_sbbzqsbgmxb3";
            //if (fys.ShowDialog() == DialogResult.OK)
            {

                ExportSBBZQSBGMXB3Edit etdjh = new ExportSBBZQSBGMXB3Edit();
        ...
        private void SubmitButton_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            ExportSBBZQSBGMXB3Edit export = new ExportSBBZQSBGMXB3Edit();
        ...
        private void barCopy_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    return;
            //}
            //IList<PJ_sbbzqsbgmxb3> bjlist = Client.ClientHelper.PlatformSqlMap.GetList<PJ_sbbzqsbgmxb3>("where orgcode='" + btGdsList.EditValue + "' AND jhnf='"+DateTime.Now.Year+"'");
            //List<PJ_sbbzqsbgmxb3> list = new List<PJ_sbbzqsbgmxb3>();
            //foreach (PJ_sbbzqsbgmxb3 bj in bjlist)
            //{
            //    bj.ID = bj.CreateID();
