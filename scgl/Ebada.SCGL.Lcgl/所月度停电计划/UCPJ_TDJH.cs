...
namespace Ebada.Scgl.Lcgl {
    ...
    public partial class UCPJ_TDJH : DevExpress.XtraEditors.XtraUserControl {
        ...
        private void ChangeText() {
            bool flag = true;
            if (parentObj != null) {
                btView.Caption = "导出\"" + parentObj.OrgName + "\"全部历史计划";
                barExplorMonth.Caption = "导出\"" + parentObj.OrgName + "\"下月计划";
            } else {
                flag = false;
            }
            btView.Visibility = flag ? DevExpress.XtraBars.BarItemVisibility.Always : DevExpress.XtraBars.BarItemVisibility.Never;
            barExplorMonth.Visibility = flag ? DevExpress.XtraBars.BarItemVisibility.Always : DevExpress.XtraBars.BarItemVisibility.Never;
        }
