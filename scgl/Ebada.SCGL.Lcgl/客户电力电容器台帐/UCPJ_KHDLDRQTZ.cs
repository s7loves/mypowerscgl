...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_KHDLDRQTZ : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_khdldrqtz> gridViewOperation;

        public event SendDataEventHandler<PJ_khdldrqtz> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_khdldrqtz,LP_Record";
        ...
        public UCPJ_KHDLDRQTZ()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_khdldrqtz>(gridControl1, gridView1, barManager1, new frmKHDLDRQTZEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_khdldrqtz>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_khdldrqtz>(gridViewOperation_AfterAdd);
            gridViewOperation.AfterDelete += new ObjectEventHandler<PJ_khdldrqtz>(gridViewOperation_AfterDelete);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_khdldrqtz>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }
        void gridViewOperation_AfterDelete(PJ_khdldrqtz obj)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_khdldrqtz> e)
        {

        }
        void gridViewOperation_AfterAdd(PJ_khdldrqtz newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_khdldrqtz> e)
        {
            if (parentID == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_khdldrqtz);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_khdldrqtz> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_khdldrqtz newobj)
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            IList<PJ_khdldrqtz> datalist = gridView1.DataSource as IList<PJ_khdldrqtz>;
            ExportKHDLDRQTZ etdjh = new ExportKHDLDRQTZ();
