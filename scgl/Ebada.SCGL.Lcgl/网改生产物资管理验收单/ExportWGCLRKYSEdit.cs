...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 文档
    /// </summary>
    public class ExportWGCLRKYSEdit
    {
        ...
        public void ExportExcel(string orgid, string year)
        {
            ...
            //ex.Open(fname);
            //IList mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpmc  from PJ_wgclrkysd order by wpmc");
            //string  strfirst = "",str="";
        ...
        public void ExportExcel(ExcelAccess ex ,IList<PJ_wgclrkysd> datalist)
        {
            //此处写填充内容代码
            int row = 9;
            int col = 1;
