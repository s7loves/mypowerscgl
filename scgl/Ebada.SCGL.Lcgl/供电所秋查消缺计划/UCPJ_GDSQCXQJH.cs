...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_GDSQCXQJH : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_qcxqjh> gridViewOperation;

        public event SendDataEventHandler<PJ_qcxqjh> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_qcxqjh,LP_Record";
        ...
        public UCPJ_GDSQCXQJH()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_qcxqjh>(gridControl1, gridView1, barManager1, new frmGDSQCXQJHEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_qcxqjh>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_qcxqjh>(gridViewOperation_BeforeUpdate);
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_qcxqjh> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_qcxqjh> e)
        {
            if (parentID == null)
                e.Cancel = true;
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_qcxqjh);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_qcxqjh> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_qcxqjh newobj)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_qcxqjh;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_qcxqjh>(frm.pjobject);
