...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_LCFXWTJZGLS : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_lcfxwtjzgls> gridViewOperation;

        public event SendDataEventHandler<PJ_lcfxwtjzgls> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_lcfxwtjzgls,LP_Record";
        ...
        public UCPJ_LCFXWTJZGLS()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_lcfxwtjzgls>(gridControl1, gridView1, barManager1, new frmLCFXWTJZGLSEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_lcfxwtjzgls>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_lcfxwtjzgls>(gridViewOperation_BeforeUpdate);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_lcfxwtjzgls>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_lcfxwtjzgls>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }

        void gridViewOperation_AfterAdd(PJ_lcfxwtjzgls newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_lcfxwtjzgls> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_lcfxwtjzgls> e)
        {
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_lcfxwtjzgls);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_lcfxwtjzgls> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_lcfxwtjzgls newobj)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_lcfxwtjzgls;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_lcfxwtjzgls>(frm.pjobject);
