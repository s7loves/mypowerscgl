...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_JLKP : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_jlkp> gridViewOperation;

        public event SendDataEventHandler<PJ_jlkp> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_jlkp,LP_Record";
        ...
        public UCPJ_JLKP()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_jlkp>(gridControl1, gridView1, barManager1, new frmJLKPEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_jlkp>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_jlkp>(gridViewOperation_BeforeUpdate);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_jlkp>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_jlkp>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }

        void gridViewOperation_AfterAdd(PJ_jlkp newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_jlkp> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_jlkp> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_jlkp> e)
        {
            if (parentID == null)
                e.Cancel = true;
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_jlkp);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_jlkp> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_jlkp newobj)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_jlkp;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_jlkp>(frm.pjobject);
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.FocusedRowHandle > -1)
            {
                PJ_jlkp OBJECT = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_jlkp;
