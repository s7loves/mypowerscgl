...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCDYJCZZSZTZ : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_dyjczzsztz> gridViewOperation;

        public event SendDataEventHandler<PJ_dyjczzsztz> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_dyjczzsztz,LP_Record";
        ...
        public UCDYJCZZSZTZ()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_dyjczzsztz>(gridControl1, gridView1, barManager1, new frmDYJCZZSZTZEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_dyjczzsztz>(gridViewOperation_BeforeAdd);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_dyjczzsztz>(gridViewOperation_AfterAdd);
            gridViewOperation.AfterDelete += new ObjectEventHandler<PJ_dyjczzsztz>(gridViewOperation_AfterDelete);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_dyjczzsztz>(gridViewOperation_BeforeDelete);
        ...
        void gridViewOperation_AfterDelete(PJ_dyjczzsztz obj)
        {
        ...
        void gridViewOperation_AfterAdd(PJ_dyjczzsztz newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_dyjczzsztz> e)
        {
           
        }

        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_dyjczzsztz> e)
        {
            if (parentID == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_dyjczzsztz);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_dyjczzsztz> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_dyjczzsztz newobj)
        {
            if (parentID == null) return;
            newobj.OrgCode = parentID;
            newobj.OrgName = parentObj.OrgName;
            newobj.jddate = DateTime.Now;
        ...
        private void barCopy_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    return;
            //}
            //IList<PJ_dyjczzsztz> bjlist = Client.ClientHelper.PlatformSqlMap.GetList<PJ_dyjczzsztz>("where orgcode='" + btGdsList.EditValue + "' AND jhnf='"+DateTime.Now.Year+"'");
            //List<PJ_dyjczzsztz> list = new List<PJ_dyjczzsztz>();
            //foreach (PJ_dyjczzsztz bj in bjlist)
            //{
            //    bj.ID = bj.CreateID();
