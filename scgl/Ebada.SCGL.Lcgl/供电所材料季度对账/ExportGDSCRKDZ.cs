...
namespace Ebada.Scgl.Lcgl
{
    ...
    public class ExportGDSCRKDZ
    {
        ...
        public void ExportGDSRKDExcel(string orgCode, string endTime)
        {
            ...
            IList<PJ_gdscrk> datalist = ClientHelper.PlatformSqlMap.GetList<PJ_gdscrk>(" where OrgCode='" + orgCode + "' and (indate <= '" + endTime + "' or ckdate<='" + endTime + "') order by wpmc,indate");
