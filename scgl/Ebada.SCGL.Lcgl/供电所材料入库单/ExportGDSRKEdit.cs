...
namespace Ebada.Scgl.Lcgl
{
    ...
    public class ExportGDSRKEdit
    {
        ...
        public void ExportGDSRKDExcel(string orgCode, string jingbanren)
        {
            ...
            IList<PJ_gdscrk> datalist = ClientHelper.PlatformSqlMap.GetList<PJ_gdscrk>(" where OrgCode='" + orgCode + "' and type='设置库存'");
            ...
            for (int j = 0; j < datalist.Count; j++)
            {
                ...
                ex.SetCellValue(datalist[j].wpsl, row + j, col + 4);
                ex.SetCellValue(datalist[j].indate.ToString(), row + j, col + 5);
                ex.SetCellValue(datalist[j].ly, row + j, col + 6);
        ...
        /// <param name="orgCode"></param>
        /// <param name="jingbanren"></param>
        public void ExportGDSCKDExcel(string orgCode, string jingbanren)
        {
            ExcelAccess ex = new ExcelAccess();
            SaveFileDialog saveFileDialog1 = new SaveFileDialog();
