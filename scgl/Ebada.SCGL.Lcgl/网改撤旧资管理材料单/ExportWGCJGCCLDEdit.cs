...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 文档
    /// </summary>
    public class ExportWGCJGCCLDEdit
    {
        ...
        public void ExportExcelProjectCKD(string orgid, string strProject, string strfenProject)
        {
            ...
            string filter4 = "";
            if (strProject != "全部")
                filter2 = "  where 1=1 and ssgc='" + strProject + "'  and type = '撤旧材料材料单' ";
            else
                filter2 = "  where 1=1  and type = '撤旧材料材料单' ";
            ...
            {
                if (strfenProject == "全部")
                    filter3 = "  where 1=1 and type = '撤旧材料材料单' ";
                else
                    filter3 = "  where  ssxm='" + strfenProject + "'  and type = '撤旧材料材料单' ";
                ...
                {
                    filter4 = "  where 1=1 and type = '撤旧材料材料单'"
                        + "  and ssgc='" + mc + "' "
                        + "  and ssxm='" + xm + "' ";
                    ...
                    {
                        filter = "  where 1=1 and type = '撤旧材料材料单'"
                        + "  and ssgc='" + mc + "' "
                        + "  and ssxm='" + xm
                        + "' and num= '" + sj + "' ";
                        if (isWorkflowCall)
