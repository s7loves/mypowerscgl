...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCWGCJGCCLD : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UCWGCJGCCLD()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_wgclcrkd>(gridControl1, gridView1, barManager1, new frmWGCJGCCLDEdit());
        ...
        void iniProject()
        {
            ...
            System.Collections.IList mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct ssgc  from PJ_wgclcrkd where type = '撤旧材料材料单'  and ssgc!='' ");
        ...
        private void barEditGC_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            System.Collections.IList mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct ssxm  from PJ_wgclcrkd where  ssgc='" + barEditGC.EditValue + "' and ( type = '撤旧材料材料单') and ssxm!='' ");
            repositoryItemComboBox2.Items.AddRange(mclist);

            repositoryItemComboBox3.Items.Clear();
            mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpmc  from PJ_wgclcrkd where  ssgc='" + barEditGC.EditValue + "' and ( type = '撤旧材料材料单') and wpmc!='' ");
            repositoryItemComboBox3.Items.AddRange(mclist);

            repositoryItemComboBox4.Items.Clear();
            mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpgg  from PJ_wgclcrkd where  ssgc='" + barEditGC.EditValue + "' and ( type = '撤旧材料材料单') and wpgg!='' ");
        ...
        private void barEditFGC_EditValueChanged(object sender, EventArgs e)
        {
            ...
            inidate();
            repositoryItemComboBox3.Items.Clear();
            IList mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpmc  from PJ_wgclcrkd where  ssxm='" + barEditFGC.EditValue + "' and ( type = '撤旧材料材料单') and wpmc!='' ");
            repositoryItemComboBox3.Items.AddRange(mclist);

            repositoryItemComboBox4.Items.Clear();
            mclist = ClientHelper.PlatformSqlMap.GetList("SelectOneStr", "select distinct wpgg  from PJ_wgclcrkd where  ssxm='" + barEditFGC.EditValue + "' and ( type = '撤旧材料材料单') and wpgg!='' ");
            repositoryItemComboBox4.Items.AddRange(mclist);
        ...
        private void SubmitButton_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            fys.StrSQL = "select distinct ssgc  from PJ_wgclcrkd where  (type = '撤旧材料材料单' ) ";
        ...
        private void barExplorYear_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fys.ShowDialog() == DialogResult.OK)
            {
                ExportWGCJGCCLDEdit etdjh = new ExportWGCJGCCLDEdit();
