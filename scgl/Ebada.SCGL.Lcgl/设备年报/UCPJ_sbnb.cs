...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_sbnb : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_sbnb> gridViewOperation;

        public event SendDataEventHandler<PJ_sbnb> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_sbnb,LP_Record";
        ...
        public UCPJ_sbnb()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_sbnb>(gridControl1, gridView1, barManager1, new frmsbnbEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_sbnb>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_sbnb>(gridViewOperation_BeforeUpdate);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_sbnb>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_sbnb>(gridViewOperation_BeforeDelete);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }

        void gridViewOperation_AfterAdd(PJ_sbnb newobj)
        {
            if (isWorkflowCall)
            {
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_sbnb> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_sbnb> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_sbnb> e)
        {
            if (parentID == null)
                e.Cancel = true;
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_sbnb);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_sbnb> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_sbnb newobj)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_sbnb;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_sbnb>(frm.pjobject);
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.FocusedRowHandle > -1)
            {
                PJ_sbnb OBJECT = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_sbnb;
