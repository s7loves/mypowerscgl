...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCWGCLRK : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public UCWGCLRK()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_wgclcrkd>(gridControl1, gridView1, barManager1, new frmWGCLRKEdit());
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_wgclcrkd> e)
        {
            ...
            if (pnumli.Count == 0)
                e.Value.num = "SCRK" + DateTime.Now.ToString("yyyyMMdd") + string.Format("{0:D4}", 1);
            else
            {
                e.Value.num = "SCRK" + (Convert.ToDecimal(pnumli[0].num.Replace("SCRK","")) + 1);
        ...
        private void btAddKuCun_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                frmWGCLRKEdit frm = new frmWGCLRKEdit();
                frm.RowData = cl;
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            ...
            if (fys.ShowDialog() == DialogResult.OK)
            {
                ...
                ExportCLRKEdit etdjh = new ExportCLRKEdit();
        ...
        private void SubmitButton_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fys.ShowDialog() == DialogResult.OK)
            {
                ExportCLRKEdit export = new ExportCLRKEdit();
        ...
        private void barExplorYear_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (fys.ShowDialog() == DialogResult.OK)
            {
                ExportWGCLRKEdit etdjh = new ExportWGCLRKEdit();
