...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_dlxxt : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_gypdxldxxtt> gridViewOperation;

        public event SendDataEventHandler<PJ_gypdxldxxtt> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_gypdxldxxtt,LP_Record";
        ...
        public UCPJ_dlxxt()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_gypdxldxxtt>(gridControl1, gridView1, barManager1, new frmdlxxtEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_gypdxldxxtt>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_gypdxldxxtt>(gridViewOperation_BeforeUpdate);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_gypdxldxxtt>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_gypdxldxxtt>(gridViewOperation_BeforeDelete);
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_gypdxldxxtt> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_gypdxldxxtt> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_gypdxldxxtt> e)
        {
            if (parentID == null)
                e.Cancel = true;
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_gypdxldxxtt);
        }
        ...
        public void InitData()
        {
            ...
            IList<PJ_gypdxldxxtt> li = MainHelper.PlatformSqlMap.GetList<PJ_gypdxldxxtt>("SelectPJ_gypdxldxxttList", str);
            if (li.Count != 0)
            {
        ...
        public void InitColumns()
        {
            ...
            {
                gridView1.Columns[i].Caption = AttributeHelper.GetDisplayName(typeof(PJ_gypdxldxxtt), gridView1.Columns[i].FieldName);
            }

            picview = new DevExpress.XtraGrid.Columns.GridColumn();
            picview.Caption = "单线系统图";
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_gypdxldxxtt> GridViewOperation
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_gypdxldxxtt;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_gypdxldxxtt>(frm.pjobject);
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (gridView1.FocusedRowHandle > -1)
            {
                PJ_gypdxldxxtt OBJECT = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_gypdxldxxtt;
        ...
        private void btReDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                MainHelper.PlatformSqlMap.DeleteByWhere<PJ_gypdxldxxtt>(" where id ='" + dr["ID"].ToString() + "'");
                InitData();
            }
            catch (Exception ex)
            {
        ...
        private void repositoryItemHyperLinkEdit1_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                try
                {
                    ...
                    GisHelper.ShowDxt(dr["LineCode"].ToString());
                }
                catch(Exception ex)
                {
