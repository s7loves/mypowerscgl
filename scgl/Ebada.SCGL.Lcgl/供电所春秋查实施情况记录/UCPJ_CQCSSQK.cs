...
namespace Ebada.Scgl.Lcgl
{
    ...
    /// 
    /// </summary>
    public partial class UCPJ_CQCSSQK : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<PJ_cqcssqk> gridViewOperation;

        public event SendDataEventHandler<PJ_cqcssqk> FocusedRowChanged;
        ...
        private string varDbTableName = "PJ_cqcssqk,LP_Record";
        ...
        public UCPJ_CQCSSQK()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_cqcssqk>(gridControl1, gridView1, barManager1, new frmCQCSSQKEdit());
            gridViewOperation.BeforeAdd += new ObjectOperationEventHandler<PJ_cqcssqk>(gridViewOperation_BeforeAdd);
            gridViewOperation.BeforeUpdate += new ObjectOperationEventHandler<PJ_cqcssqk>(gridViewOperation_BeforeUpdate);
            gridViewOperation.CreatingObjectEvent += gridViewOperation_CreatingObjectEvent;
            gridViewOperation.AfterAdd += new ObjectEventHandler<PJ_cqcssqk>(gridViewOperation_AfterAdd);
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<PJ_cqcssqk>(gridViewOperation_BeforeDelete);
        ...
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<PJ_cqcssqk> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<PJ_cqcssqk> e)
        {
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<PJ_cqcssqk> e)
        {
            if (parentID == null)
                e.Cancel = true;
            e.Value.OrgCode = parentID;
            e.Value.OrgName = parentObj.OrgName;
            e.Value.ssrq = DateTime.Now;
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as PJ_cqcssqk);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<PJ_cqcssqk> GridViewOperation
        {
        ...
        void gridViewOperation_CreatingObjectEvent(PJ_cqcssqk newobj)
        {
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as PJ_cqcssqk;
            //    if (frm.ShowDialog() == DialogResult.OK)
            //    {
            //        Client.ClientHelper.PlatformSqlMap.Update<PJ_cqcssqk>(frm.pjobject);
