...
namespace Ebada.Exam {
    ...
    /// </summary>
    //[ToolboxItem(false)]
    public partial class UCE_QBank : DevExpress.XtraEditors.XtraUserControl {
        private GridViewOperation<E_QBank> gridViewOperation;
        private string parentID = null;
        private E_QBank parentObj;
        public event SendDataEventHandler<E_QBank> FocusedRowChanged;

        public UCE_QBank()
        {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<E_QBank>(gridControl1, gridView1, barManager1,new FrmE_QBankEdit());
        ...
        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<E_QBank> e) {
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<E_QBank> GridViewOperation {
        ...
        void gridViewOperation_CreatingObjectEvent(E_QBank newobj) {
