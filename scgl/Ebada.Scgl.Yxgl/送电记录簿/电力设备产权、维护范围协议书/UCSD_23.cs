...
namespace Ebada.Scgl.Yxgl
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class UCSD_23 : DevExpress.XtraEditors.XtraUserControl
    {
        private GridViewOperation<sdjl_23> gridViewOperation;

        public event SendDataEventHandler<sdjl_23> FocusedRowChanged;
        ...
        public UCSD_23()
        {
            ...
            gridViewOperation.BeforeDelete += new ObjectOperationEventHandler<sdjl_23>(gridViewOperation_BeforeDelete);
            gridViewOperation.AfterEdit += new ObjectEventHandler<sdjl_23>(gridViewOperation_AfterEdit);
            gridViewOperation.AfterAdd += new ObjectEventHandler<sdjl_23>(gridViewOperation_AfterAdd);
            gridView1.FocusedRowChanged += gridView1_FocusedRowChanged;
        }
        void gridViewOperation_BeforeUpdate(object render, ObjectOperationEventArgs<sdjl_23> e)
        {
        ...
        void gridViewOperation_BeforeDelete(object render, ObjectOperationEventArgs<sdjl_23> e)
        {
           
        }

        void gridViewOperation_BeforeAdd(object render, ObjectOperationEventArgs<sdjl_23> e)
        {
            if (parentID == null)
                e.Cancel = true;
        }
        ...
        void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            if (FocusedRowChanged != null)
                FocusedRowChanged(gridView1, gridView1.GetFocusedRow() as sdjl_23);
        }
        ...
        /// </summary>
        [Browsable(false)]
        public GridViewOperation<sdjl_23> GridViewOperation
        {
        ...
        private void btView_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            sdjl_23 OBJECT = gridView1.GetRow(gridView1.FocusedRowHandle) as sdjl_23;
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                //修改模板
                sdjl_23 rowData = gridView1.GetRow(gridView1.FocusedRowHandle) as sdjl_23;
                ...
                //dsoFramerControl1.Dispose();
                //dsoFramerControl1 = null;
                //MainHelper.PlatformSqlMap.Update<sdjl_23>(rowData);

                frmSD23Template frm = new frmSD23Template();
                //frm.pjobject = gridView1.GetRow(gridView1.FocusedRowHandle) as sdjl_23;
                frm.pjobject = rowData;
                if (frm.ShowDialog() == DialogResult.OK)
                {
                    Client.ClientHelper.PlatformSqlMap.Update<sdjl_23>(frm.pjobject);
