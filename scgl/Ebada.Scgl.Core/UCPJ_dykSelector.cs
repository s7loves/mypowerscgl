...
namespace Ebada.Scgl.Core {
    ...
    public partial class UCPJ_dykSelector : DevExpress.XtraEditors.XtraUserControl {
        ...
        public UCPJ_dykSelector() {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<PJ_dyk>(gridControl1, gridView1, barManager1,null,new UCPJ_dykFind());
        ...
        /// </summary>
        /// <returns></returns>
        public PJ_dyk GetSelectedRow() {
            PJ_dyk dyk=null;
            if (gridView1.GetFocusedRow() != null)
                dyk = gridView1.GetFocusedRow() as PJ_dyk;
            return dyk;
        }
