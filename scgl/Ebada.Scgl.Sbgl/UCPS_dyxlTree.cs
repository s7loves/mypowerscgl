...
namespace Ebada.Scgl.Sbgl {
    ...
    public partial class UCPS_dyxlTree : DevExpress.XtraEditors.XtraUserControl {
        ...
        string getcode(TreeListNode pnode, TreeListNodes nodes) {
            ...
            string sql = string.Format("Select max(LineCode) as LineCode from ps_xl where len(linecode)={2} and Left(linecode,{0})='{1}' and linevol>=10.0", linecode.Length, linecode, linecode.Length + levenum);
