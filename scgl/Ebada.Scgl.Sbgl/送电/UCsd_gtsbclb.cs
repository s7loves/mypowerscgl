...
namespace Ebada.Scgl.Sbgl {
    ...
    /// </summary>
    [ToolboxItem(false)]
    public partial class UCsd_gtsbclb : DevExpress.XtraEditors.XtraUserControl {
        ...
        public UCsd_gtsbclb() {
            InitializeComponent();
            initImageList();
            gridViewOperation = new GridViewOperation<sd_gtsbclb>(gridControl1, gridView1, barManager1,new frmsd_gtsbclbclEdit());
